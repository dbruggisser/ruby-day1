...
puts 10 * 5 * 11 * 60 * 60 #prints 1980000

puts "Est-ce que c'est vrai que 3 + 2 < 5 - 7 ?" #prints a string

puts 3 + 2 < 5 - 7 #prints false

puts "Ça fait combien 3 + 2 ? #{3 + 2}" #prints Ça fait combien 3 + 2 ? 5
puts "Ça fait combien 5 - 7 ? #{5 - 7}" #prints Ça fait combien 5 - 7 ? -2

puts "Ok, c'est faux alors !" #prints a string

puts "C'est drôle ça, faisons-en plus :" #prints a string
